...
Investment.create(lender: User.first, project: Project.second, total_investment_amount: 2000.00, outstanding_balance: 2000.00, loan_tenor: 12)
Investment.create(lender: User.first, project: Project.third, total_investment_amount: 1500.00, outstanding_balance: 1500.00, loan_tenor: 12)
Investment.create(lender: User.first, project: Project.fourth, total_investment_amount: 9000.00, outstanding_balance: 9000.00, loan_tenor: 12)
Investment.create(lender: User.first, project: Project.fifth, total_investment_amount: 750.00, outstanding_balance: 750.00, loan_tenor: 12)
